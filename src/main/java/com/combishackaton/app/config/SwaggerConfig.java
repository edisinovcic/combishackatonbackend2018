...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.any())
                                                      ...
                                                      .pathMapping("/").securitySchemes(
                        new ArrayList<>(Collections.singletonList(getApiKey()))).securityContexts(
                        new ArrayList<>(Collections.singletonList(getSecurityContext())));
